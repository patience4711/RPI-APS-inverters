...
From now on, the latest update will completely update your system to the newest version. No need anymore to do the updates one by one. Example: You have version 2_7. Now install 3_1 (2 times!) and than 3_2. After you installed v3_2 you need to reboot for some settings to effectuate. So it's best to do this after the polling stopped. 
