...
2023-12-15 A new sd-card image version RPI-ECU-v3_9 is available (see changelog). [RPI-ECU-v3_9.zip]([https://1drv.ms/u/s!AkMG5FvUwhedi23kR54Gv4thd3GW?e=v22Kj3](https://1drv.ms/u/s!AkMG5FvUwhedjUN07jjP0emFcuW4?e=CwkCc2))<br>This has to be installed by burning the disk image to an sdcard. Before you start please read the instructions. If you want to backup and restore your settings and databases, be sure you have version RPI-ECU-v2_3 or above. And schedule some time after midnight to perform the migration. Please follow the steps in **installation via the sd-card image** , in particular it is important that you expand the filesystem first and than wait for influxdb is running, before restoring your backup!!.
<br>

## DOWNLOAD SOFTWARE UPDATES
2022-12-14: [ecu_swupdate-v3_9.tar](https://github.com/patience4711/RPI-APS-inverters/blob/main/ecu_swupdate-3_9.tar) is available (see changelog). Install this only when you are running version 3_1 or higher (please see the expanation to version 3_1 below).<br>If you experience malformed webpages, please clear your browser cache (delete web history saved pictures)<br><br>
